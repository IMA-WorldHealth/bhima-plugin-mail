...
// TODO -- unify all the date parsing into a single format date utility
function serializeDate(date) {
  return date.toISOString().split('T')[0];
}

// ensures a directory exists and returns the path to it.
// TODO - move this to util to share with other libs
